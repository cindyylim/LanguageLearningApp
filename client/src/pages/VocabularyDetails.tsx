    ...
    <div className="max-w-2xl mx-auto p-4">
      <div className="flex gap-2 mb-4 items-center">
        ...
        <button
          ...
          onClick={() => dispatch({ type: 'OPEN_DELETE_LIST_MODAL' })}
        >
      ...
      {showDeleteListModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-md relative">
            <button className="absolute top-2 right-2 text-gray-400 hover:text-gray-600" onClick={() => dispatch({ type: 'CLOSE_DELETE_LIST_MODAL' })}>&times;</button>
            ...
            <div className="flex gap-2 mt-4">
              ...
              <button className="btn-secondary flex-1" onClick={() => dispatch({ type: 'CLOSE_DELETE_LIST_MODAL' })}>Cancel</button>
            </div>
          </div>
        </div>
      )}
